...
#define PER_IOPORT_INSTANCE_BASEADDRESS_MAX		0xFF000000
#define PER_IOPORT_INSTANCE_BASEADDRESS_MIN		0xFF000000
...
#define PER_IOPORT_INSTANCE_PORTCOUNT_MAX		1
#define PER_IOPORT_INSTANCE_PORTCOUNT_MIN		1
