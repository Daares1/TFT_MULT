...
#define PER_SPI_INSTANCE_BASEADDRESS_MAX		0xFF020000
#define PER_SPI_INSTANCE_BASEADDRESS_MIN		0xFF020000

#define PER_SPI_INSTANCE_TRANSFERSIZE_MAX		32
#define PER_SPI_INSTANCE_TRANSFERSIZE_MIN		32
